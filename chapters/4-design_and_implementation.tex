...
\subsection{Masking Ratio for Replaced Token Detection}
...
For \acrshort{mrtd} we will experiment with the same masking schedule as we had for \acrshor{mlm}. The masking ratio for \acrshort{mlm} will be set to 15\%, \cite{Bai2023RaSaRA} was using this parameter, and the masking ratio for \acrshort{mrtd} will have fixed and time variant.
