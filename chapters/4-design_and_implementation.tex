...
\begin{itemize}
  ...
  \item Source diversity: Images are collected from various existing person re-identification datasets, including CUHK03\cite{li2014deepreid}, Market-1501\cite{7410490}, SSM\cite{ssm}, VIPER\cite{viper}, and CUHK01\cite{li2012human}.
\end{itemize}
