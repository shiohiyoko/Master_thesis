...
\begin{figure}
    ...
    \caption{The illustration features: (a) two types of positive relations in elation-aware learning, highlighting noise interference in weak positive pairs with red emphasis, and (b) replaced token detection in sensitivity-aware learning, where word replacement serves as a sensitivity transformation, with the replaced words displayed in bold. Adapted from \cite{Bai2023RaSaRA}.}
    \label{img:rasa}
\end{figure}
